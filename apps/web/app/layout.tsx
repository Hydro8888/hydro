...
export const metadata: Metadata = {
  ...
  description:
    'GPT-5.5, Claude Opus 4.8, Gemini 3.5 Flash, Grok 4.3 등 전세계 TOP 10 프리미엄 AI를 하나의 대시보드에서 비교하고 사용하세요. 무료로 시작하세요.',
  ...
  openGraph: {
    ...
    description:
      'GPT-5.5, Claude Opus 4.8, Gemini 3.5 Flash, Grok 4.3 등 전세계 TOP 10 프리미엄 AI를 하나의 대시보드에서 비교하고 사용하세요.',
    images: [
      {
