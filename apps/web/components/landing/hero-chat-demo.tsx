...
const QUESTION = 'GPT-5와 Claude, Gemini의 차이점을 알려줘';
...
const MODELS: ModelResponse[] = [
  {
    ...
    words: 'GPT-5는 복잡한 추론과 코드 생성에서 뛰어난 성능을 보입니다.'.split(' '),
  },
  {
    id: 'anthropic',
    ...
    words: 'Claude는 긴 문서 분석과 자연스러운 글쓰기에 강점이 있습니다.'.split(' '),
  },
  {
    id: 'google',
    ...
    words: 'Gemini는 이미지와 영상을 포함한 멀티모달 처리에 탁월합니다.'.split(' '),
  },
];
