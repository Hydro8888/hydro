...
export const metadata = {
  title: '중국 뉴스 - LiveNews',
  description: '중국 주요 뉴스를 실시간으로 확인하세요',
};
...
export default async function ChinaPage({
  ...
  const subcategories = COUNTRY_SUBCATEGORIES.china;

  return (
    <div className="max-w-7xl mx-auto px-4 py-6">
      <div className="flex items-center gap-3 mb-6">
        <h1 className="text-2xl font-bold">중국 뉴스</h1>
      ...
      <Pagination currentPage={page} totalPages={totalPages} basePath="/china" />
    </div>
  );
}
