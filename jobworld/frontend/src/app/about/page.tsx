  ...
  return (
    <div className="min-h-screen bg-[#f5f7fa]">
      ...
      <div className="max-w-2xl mx-auto px-6 py-12">
        ...
        <div className="bg-white border border-[#dfe3e8] rounded-2xl p-6 mb-4">
          ...
          <ul className="space-y-3">
            {[
              ...
              <li key={item} className="flex items-start gap-3 text-sm text-[#5f6368]">
        ...
        <Link href="/" className="inline-flex items-center gap-1.5 text-sm text-[#1a73e8] hover:underline mt-4">
          ← 홈으로
        </Link>
      </div>
    </div>
