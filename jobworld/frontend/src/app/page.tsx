        ...
        <div className="flex items-center gap-2 text-sm">
          {user ? (
            <>
              ...
              <button
                onClick={logout}
                className="px-4 py-1.5 text-[#1c1c1c] border border-[#dfe3e8] rounded-full hover:border-[#1a73e8] transition-colors"
              >
                로그아웃
              </button>
            </>
            ...
            <>
              ...
              <Link
                href="/register"
                className="px-4 py-1.5 font-medium text-[#1a73e8] border border-[#1a73e8] rounded-full hover:bg-[#1a73e8] hover:text-white transition-colors"
              >
                회원가입
              </Link>
            </>
      ...
      <main className="flex-1">
          ...
          <div className="flex flex-col items-start sm:items-end gap-4 sm:pb-1">
            <div className="flex items-center gap-3">
              <button
                ...
                className="px-6 py-3 bg-[#eef1f6] text-[#1c1c1c] font-medium rounded-xl border border-[#dfe3e8] hover:border-[#1a73e8] transition-colors text-sm whitespace-nowrap"
              >
                채용공고 둘러보기
              </button>
              <button
                onClick={() => router.push('/search?q=개발자&type=구인')}
                className="w-11 h-11 flex items-center justify-center rounded-full border border-[#dfe3e8] text-[#5f6368] hover:border-[#1a73e8] hover:text-[#1a73e8] transition-colors bg-[#eef1f6]"
                aria-label="AI 검색"
              >
            ...
            <p className="text-sm text-[#5f6368] sm:text-right max-w-[240px]">
        ...
        <section className="max-w-6xl mx-auto px-6 pb-12">
          <div
            ...
            style={{ background: 'linear-gradient(135deg, #4285f4 0%, #1a73e8 40%, #6ea8fe 70%, #e8f0fe 100%)', minHeight: '340px' }}
          >
            {/* SVG 추상 라인 장식 */}
            <svg
            ...
            >
              <path d="M-20 280 Q150 100 320 200 Q490 300 600 80 Q710 -40 900 120" stroke="#1a73e8" strokeWidth="1.5" strokeOpacity="0.5" fill="none" />
              <path d="M-20 320 Q200 160 380 240 Q520 300 650 120 Q750 20 920 180" stroke="#1a73e8" strokeWidth="1" strokeOpacity="0.35" fill="none" />
              <path d="M100 -20 Q200 120 160 240 Q130 320 200 380" stroke="#1a73e8" strokeWidth="1.2" strokeOpacity="0.4" fill="none" />
              <path d="M300 -10 Q380 80 340 180 Q310 260 380 340" stroke="#1a73e8" strokeWidth="0.8" strokeOpacity="0.3" fill="none" />
              <ellipse cx="420" cy="160" rx="180" ry="100" stroke="#1a73e8" strokeWidth="1" strokeOpacity="0.25" fill="none" transform="rotate(-20 420 160)" />
            </svg>
            ...
            <div className="absolute right-6 top-1/2 -translate-y-1/2 flex flex-col gap-3 w-64 hidden sm:flex">
              ...
              <div className="bg-white/90 backdrop-blur-sm rounded-xl p-4 shadow-sm border border-white/60">
                <div className="flex items-center gap-3">
                  <div className="w-9 h-9 rounded-full bg-[#e8f0fe] flex items-center justify-center shrink-0">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-[#5f6368]">47개 채용공고 발견</p>
                  </div>
                  <div className="ml-auto w-8 h-4 rounded-full bg-[#1a73e8] flex items-center justify-end pr-0.5">
              ...
              <div className="bg-white/95 backdrop-blur-sm rounded-xl p-4 shadow-md border border-white/80">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-[#5f6368]">AI 맞춤 추천 활성화</p>
                  </div>
                </div>
                <div className="mt-3 flex items-center gap-2">
                  <div className="w-6 h-3 rounded-full bg-[#1a73e8] flex items-start p-0.5">
                    <div className="w-2 h-2 rounded-full bg-white" />
                  </div>
                  <span className="text-xs text-[#5f6368]">활성화됨</span>
                  <Link href="/search?q=개발자&type=구직" className="ml-auto text-xs text-[#1a73e8] font-medium hover:underline">
                    검색하기 →
                  </Link>
                </div>
              </div>
            ...
            <div className="relative z-10 p-8 sm:max-w-[55%]">
              <p className="text-sm font-medium text-[#5f6368] mb-4">AI 기반 채용 플랫폼</p>
                  ...
                  <button
                    ...
                    className={`px-4 py-1.5 rounded-full text-sm font-medium transition-all border ${
                      searchType === type
                        ...
                        : 'text-[#5f6368] border-[#dfe3e8] bg-white/60 hover:bg-white/80'
                    }`}
                  >
              ...
              <form onSubmit={handleSearch}>
                <div className="flex items-center bg-white rounded-xl px-4 py-3 shadow-sm border border-white/80">
                  ...
                  <button
                    type="submit"
                    className="ml-3 px-4 py-1.5 bg-[#1a73e8] text-white text-xs font-medium rounded-lg hover:bg-[#1557b0] transition-colors shrink-0"
                  >
                    검색
                  </button>
                </div>
              ...
              <div className="flex flex-wrap gap-2 mt-4">
                {quickLinks[searchType].map((link) => (
                  <button
                    ...
                    className="text-xs text-[#5f6368] bg-white/70 border border-white/80 rounded-full px-3 py-1 hover:bg-white transition-colors"
                  >
                    {link.label}
                  </button>
                ))}
        ...
        <section className="max-w-6xl mx-auto px-6 pb-16">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {/* 카드 1: AI 검색 */}
            <div className="bg-white rounded-2xl p-6 border border-[#dfe3e8]">
            ...
            {/* 카드 2: 보안 & 신뢰 */}
            <div className="bg-white rounded-2xl p-6 border border-[#dfe3e8]">
              <div className="w-10 h-10 rounded-xl bg-[#eef1f6] flex items-center justify-center mb-4">
